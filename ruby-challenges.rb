...
def sum_arrays(array_of_numbers)
    array_of_numbers.sum
end

p sum_arrays(nums_array1)
p sum_arrays(nums_array2)
...
class Bike
    ...
    def brake(decrease_rate)
        @current_speed = [@current_speed - decrease_rate, 0].max
        p @current_speed
    end
end

my_bike = Bike.new('Trek')
my_bike.display_information
